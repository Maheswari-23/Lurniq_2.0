  ...
  return (
    <div className="vark-container">
      ...
      <div className="vark-header">
        ...
        <p className="subtitle">Experience the Water Cycle through four unique learning modalities ΓÇö and discover which one feels most <em>you</em>.</p>

        {/* Cold-start banner */}
        <div className="cold-start-banner">
          <div className="cold-start-icon">≡ƒö¼</div>
          <div className="cold-start-text">
            <strong>We're silently calibrating your profile</strong>
            <p>
              Since this is your <span className="cold-start-badge">cold start</span>, our AI watches how you naturally engage ΓÇö do you click videos, read articles, listen to audio, or drag things around?
              Just explore what feels natural. We'll use your behaviour to personalise your entire learning journey. No forms. No guessing. Pure intelligence. Γ£¿
            </p>
          </div>
        </div>
      </div>

      {/* ΓöÇΓöÇ 4-column card grid ΓöÇΓöÇ */}
      <div className="vark-grid">

        {/* ΓöÇΓöÇ Visual ΓöÇΓöÇ */}
        <div
        ...
        >
          ...
          <div className="card-inner">
            ...
            <div className="audio-content">
              <h3>≡ƒîº∩╕Å The Sound of Precipitation</h3>
              <p>Listen carefully ΓÇö each raindrop is evidence of the water cycle completing its loop. Precipitation is nature's way of returning water from atmosphere back to Earth.</p>
            </div>
        ...
        >
          ...
          <div className="card-inner">
            ...
            >
              ...
              <p>The water cycle is the continuous movement of water through Earth's systems ΓÇö driven by solar energy and gravity, it sustains all life.</p>

              <div className="step-section">
                <h4>Step 1 ΓÇö Evaporation</h4>
                <p>Solar energy heats surface water, converting it into water vapour that rises into the atmosphere.</p>
              </div>
              <div className="step-section">
                <h4>Step 2 ΓÇö Condensation</h4>
                <p>As vapour rises and cools, it condenses around tiny particles, forming clouds and fog.</p>
              </div>
              <div className="step-section">
                <h4>Step 3 ΓÇö Precipitation</h4>
              ...
              <div className="key-words">
                ...
                <div className="keyword-grid">
                  <div className="keyword-item"><strong>Evaporation:</strong> Liquid ΓåÆ water vapour via heat</div>
                  <div className="keyword-item"><strong>Condensation:</strong> Vapour ΓåÆ liquid droplets via cooling</div>
                  <div className="keyword-item"><strong>Precipitation:</strong> Atmospheric water ΓåÆ Earth's surface</div>
                </div>
              </div>

              <p className="conclusion">The water cycle is a closed system ΓÇö the same water has been recycled for billions of years.</p>
            </div>
                  ...
                  {availableLabels.length > 0 ? (
                    ...
                    <div className="completion-feedback">
                      {droppedItems["step-1"] === "Evaporation" &&
                        ...
                        ? <p className="success-message">≡ƒÄë Perfect sequence!</p>
                        : <div>
                            <p className="error-message">Not quite right ΓÇö try again!</p>
                            <button className="reset-btn" onClick={handleReset}>Γå║ Reset</button>
                          </div>
                      }
                    </div>
                  )}
                ...
                {droppedItems["step-1"] && droppedItems["step-2"] && droppedItems["step-3"] && (
                  <div className="feedback-section">
                    {droppedItems["step-1"] === "Evaporation" &&
                      droppedItems["step-2"] === "Condensation" &&
                      droppedItems["step-3"] === "Precipitation"
                      ? <p className="correct-feedback">Γ£à Correct! Evaporation ΓåÆ Condensation ΓåÆ Precipitation</p>
                      : <p className="incorrect-feedback">Γ¥î Incorrect order. Click reset to try again.</p>
                    }
                  </div>
                )}
              </div>
